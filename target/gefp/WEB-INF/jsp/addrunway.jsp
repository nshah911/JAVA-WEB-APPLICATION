...
<font face="verdana" size="15" align="center">ADD A RUNWAY</font>
</div>
...
<div class="container">
<input type="text" class="form-control" name="runway_name"/><br/>
<input type="hidden" name="pid" value="${pid}" />
<button class="btn btn-primary"  type="submit" name="add" value="OK" >Add a runway</button>
</div>
</form>
</div>
</body>
